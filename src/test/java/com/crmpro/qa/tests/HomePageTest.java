...
public class HomePageTest extends TestBase {
	...
	public void verifyUserNameTest() {   //have to switch to that frame.
		testUtil.swithToFrame(); //Will call method from TestUtil class and switch to the main panel then verifying by verifyCorrectUserName() method from HomePage  
	...
	@AfterMethod
	public void tearDown() {   //***TC should be separated & independent of each other. Because if  you don't fully shut down a browser after executing it 
		driver.quit();        //and continue to run subsequent TCs thereafter and not delete the cookies or caches then it can determinately affect the browser
